/**
 * JUNIT Tests for HashChaining class
...
public class HashChainingTests {
	...
	public void test_01_IntgerHash() { // if this test passes you are in good
										// standing
		HashChaining<Integer> testhash = new HashChaining<Integer>(40);
	...
	public void test_3_ContainsandRemoveandinsert() {
		HashChaining<Integer> testhash = new HashChaining<Integer>(10);
		testhash.insert(0);
		testhash.insert(11);
		testhash.insert(22);
		testhash.insert(33);
		...
		assertTrue(testhash.collisions() == 17);
		assertTrue(testhash.maxCollisions() == 4);
		assertTrue(testhash.avgCollisions() == (17.0 / 8.0));
